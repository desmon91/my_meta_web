export default function motix() {
  return (
    <div class="mb-10">
      <section class="flex flex-col justify-center items-center w-screen h-screen bg-[url('/motix_cover.png')] bg-no-repeat bg-cover bg-center bg-slate-700 bg-blend-overlay">
        <h1 class="text-slate-100 stroke-black text-6xl text-center font-bold">
          Motix App
        </h1>
        <h6 class="text-4xl mt-5 text-slate-100">Case Study</h6>
      </section>
      <section class="flex flex-col justify-center items-center w-screen my-10">
        <h3 class="text-4xl text-orange-500 font-bold text-center mt-10">
          Project Overview
        </h3>
        <div class="flex flex-wrap justify-evenly mt-20">
          <div class="w-1/3 m-5">
            <h6 class="text-lg text-slate-700 font-semibold">The Product</h6>
          ...
          <div class="w-1/3 m-5">
            <h6 class="text-lg text-slate-700 font-semibold">The Problem</h6>
            <p class="text-justify text-slate-700">
              Busy consumers lack the time to order the ticket and wait in line.
            </p>
          </div>
          <div class="w-1/3 m-5">
            <h6 class="text-lg text-slate-700 font-semibold">My Role</h6>
            <p class="text-justify text-slate-700">
              UX designer designing an app from conception to delivery.
            </p>
          </div>
          <div class="w-1/3 m-5">
            <h6 class="text-lg text-slate-700 font-semibold">
              Project Duration
            </h6>
            <p class="text-justify text-slate-700">1 - 20 January 2022</p>
          </div>
          <div class="w-1/3 m-5">
            <h6 class="text-lg text-slate-700 font-semibold">The Goal</h6>
            <p class="text-justify text-slate-700">
      ...
      <section class="flex flex-col justify-center items-center w-screen my-10">
        <div class="w-4/5 flex flex-col justify-center">
          ...
          <p class="text-center text-slate-700 mt-10">
      ...
      <section class="flex flex-col justify-center items-center w-screen my-10">
        ...
        <div class="w-4/5 flex flex-row justify-around mt-10">
          <div class="w-1/3 m-5">
            <h6 class="text-lg text-slate-700 font-semibold">Time</h6>
            <p class="text-justify text-slate-700">
              Conducting interviews, paper and digital wireframing, low and
              high-fidelity prototyping, conducting usability studies,
              accounting for accessibility, and iterating on designs.
          ...
          <div class="w-1/3 m-5">
            <h6 class="text-lg text-slate-700 font-semibold">Payment</h6>
            <p class="text-justify text-slate-700">
              Conducting interviews, paper and digital wireframing, low and
              high-fidelity prototyping, conducting usability studies,
              accounting for accessibility, and iterating on designs.
      ...
      <section class="flex flex-col justify-center items-center w-screen my-10">
        <div class="w-4/5 flex flex-col justify-center">
          ...
          <img src="/motix_persona.jpg" class="w-full h-full my-5" />
        </div>
      </section>
      <section class="flex flex-col justify-center items-center w-screen mt-10">
        <div class="w-4/5 flex flex-col justify-center">
          ...
          <img src="/motix_user_journey.jpg" class="w-full h-full my-5" />
        </div>
      </section>
      <section class="flex flex-col justify-center items-center w-screen mt-10">
        <div class="w-4/5 flex flex-col justify-center">
          ...
          <img src="/motix_paper_wireframe.jpg" class="w-full h-full my-5" />
        </div>
      </section>
      <section class="flex flex-col justify-center items-center w-screen mt-10">
        <h3 class="text-4xl text-orange-500 font-bold text-center">
        ...
        <div class="w-4/5 flex flex-row justify-around mt-10">
          <div class="w-1/3 m-5">
            <img src="/motix0.png" class="w-auto h-auto" />
          ...
          <div class="w-1/3 m-5">
            <img src="/motix1.png" class="w-auto h-auto" />
            <h6 class="text-lg text-center text-slate-700 font-semibold mt-5">
              Payment Screen
            </h6>
            <p class="text-center text-slate-700">
      ...
      <section class="flex flex-col justify-center items-center w-screen mt-10">
        <div class="w-4/5 flex flex-col justify-center">
          ...
          <div class="w-full flex flex-row justify-around items-center mt-10">
      ...
      <section class="flex flex-col justify-center items-center w-screen mt-10">
        ...
        <div class="w-4/5 flex flex-row flex-wrap justify-around mt-10 items-center">
          <div class="w-1/3 m-5">
            <img src="/motix1b.png" class="w-auto h-auto" />
          </div>
          <div class="w-1/3 m-5">
            <p class="text-justify text-slate-700">
          ...
          <div class="w-1/3 m-5">
            <img src="/motix2.png" class="w-auto h-auto" />
          </div>

          <div class="w-1/3 m-5">
            <img src="/motix3.jpg" class="w-auto h-auto" />
          </div>
          <div class="w-1/3 m-5">
            <p class="text-justify text-slate-700">
      ...
      <section class="flex flex-col justify-center items-center w-screen mt-10">
        ...
        <img src="/motix4.png" class="w-full h-full p-20" />
      </section>
      <section class="flex flex-col justify-center items-center w-screen mt-10">
        <h3 class="text-4xl text-orange-500 font-bold text-center">Takeways</h3>
        <div class="w-4/5 flex flex-row justify-around mt-10">
          <div class="w-1/3 m-5">
            <h6 class="text-lg text-slate-700 font-semibold">Impact</h6>
            <p class="text-justify text-slate-700">
          ...
          <div class="w-1/3 m-5">
            <h6 class="text-lg text-slate-700 font-semibold">What I Learned</h6>
            <p class="text-justify text-slate-700">
