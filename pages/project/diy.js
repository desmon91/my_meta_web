      ...
      <div className="mb-10">
        ...
        <section className="flex flex-col justify-center items-center w-screen min-h-screen my-10">
          <div className="w-4/5 flex flex-col justify-center">
            ...
            <p className="text-center text-slate-700 mt-5">
              ...
              of fake videos tutorial that users found online which was not
              really helpful and also there are a lot of low quality tutorials
              which was not completely explain what happened in the videos for
              the people to follow along.
            </p>
          </div>
        </section>
        <section className="flex flex-col justify-center items-center w-screen min-h-screen my-10">
          ...
          <div className="w-4/5 flex flex-row justify-around">
            ...
            <div className="w-1/3 m-5">
              ...
              <p className="text-justify text-slate-700 mt-2">
                Customer need a high quality tutorial that people can follow
                along
              </p>
            </div>
          </div>
        ...
        <section className="flex flex-col justify-center items-center w-screen min-h-screen my-10">
          <div className="w-4/5 flex flex-col justify-center">
            ...
            <p className="text-center text-slate-700 mt-5">
              By looking at a journey map we can see that the users need a
              better tools to find good tutorials online.
            </p>
            <img
              alt=""
        ...
        <section className="flex flex-col justify-center items-center w-screen min-h-screen my-10">
          ...
          <div className="w-4/5 flex flex-row justify-around items-start">
            <div className="w-1/3 m-5 flex flex-col justify-center ">
              ...
              <p className="text-center text-slate-700 mt-2">
                This is the initial design phase, which is more focused on
                finding and showing tutorial videos.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="flex flex-col justify-center items-center w-screen min-h-screen my-10">
          ...
          <div className="w-4/5 flex flex-row justify-around mt-5">
            ...
            <div className="w-1/3 m-5">
              ...
              <p className="text-justify text-slate-700 mt-2">
                Tutorial videos are there to help people, but nowadays people
                just don’t care about it and upload whatever they like to just
                gain views and fame.
              </p>
            </div>
          </div>
