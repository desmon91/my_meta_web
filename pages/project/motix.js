      ...
      <div className="mb-10">
        ...
        <section className="flex flex-col justify-center items-center w-screen min-h-screen my-10">
          ...
          <div className="flex flex-wrap justify-evenly mt-10">
            ...
            <div className="w-1/3 m-5">
              ...
              <p className="text-center text-slate-700 mt-2">
                Busy consumers lack the time to order the ticket and wait in
                line.
              </p>
            </div>
            <div className="w-1/3 m-5">
        ...
        <section className="flex flex-col justify-center items-center w-screen min-h-screen my-10">
          <div className="w-4/5 flex flex-col justify-center">
            ...
            <p className="text-center text-slate-700 mt-5">
              ...
              that there were two types of customers, the single customer, and
              the family customer. From this interview, we can conclude that
              they need a way to book a ticket in advance without waiting, be
              able to browse a movie list with ease and have various payment
              options.
            </p>
          </div>
        </section>
        ...
        <section className="flex flex-col justify-center items-center w-screen min-h-screen my-10">
          <div className="w-4/5 flex flex-col justify-center">
            ...
            <p className="text-center text-slate-700 mt-5">
              As a busy mother with 2 kids, Anna wants to watch a kids safe
              movie and buy a ticket in advance so that she can watch the movie
              with my kids without worry.
            </p>
        ...
        <section className="flex flex-col justify-center items-center w-screen min-h-screen my-10">
          ...
          <div className="w-4/5 flex flex-row flex-wrap justify-around mt-10 items-center">
            ...
            <div className="w-1/3 m-5">
              <p className="text-justify text-slate-700">
                After usability study 1, the design do not have a login page
                which made the users confused on accessing the app
              </p>
            </div>
            <div className="w-1/3 m-5">
        ...
        <section className="flex flex-col justify-center items-center w-screen min-h-screen my-10">
          ...
          <div className="w-4/5 flex flex-row justify-around mt-5">
            <div className="w-1/3 m-5">
              ...
              <p className="text-center text-slate-700 mt-2">
                Provided an access to change the language to English for those
                who are not familiar with the Indonesian language.
              </p>
            </div>
            <div className="w-1/3 m-5">
              <h6 className="text-lg text-center text-slate-700 font-semibold">
          ...
          <div className="w-4/5 flex flex-row justify-around mt-5">
            ...
            <div className="w-1/3 m-5">
              ...
              <p className="text-justify text-slate-700 mt-2">
                ...
                because we can see directly how the users interact with our
                design and what part of the app do they really need the most.
              </p>
            </div>
          </div>
        </section>
        <section className="flex flex-col justify-center items-center w-screen min-h-screen my-10">
          ...
          <div className="w-4/5 flex flex-row justify-around mt-5">
            <div className="w-1/3 m-5">
              ...
              <p className="text-justify text-slate-700 mt-2">
                Conduct design critique session with colleagues to see what I
                have missed in the process before going to the production team.
              </p>
            </div>
            <div className="w-1/3 m-5">
              <h6 className="text-lg text-center text-slate-700 font-semibold">
              ...
              <p className="text-justify text-slate-700 mt-2">
                Clean up and wrap up the design after the design critique
                session.
              </p>
            </div>
          </div>
