...
export default function esimper() {
  return (
    <div class="mb-10">
      <section class="flex flex-col justify-center items-center w-screen h-screen bg-[url('/esimper_cover.png')] bg-no-repeat bg-cover bg-center bg-slate-700 bg-blend-overlay">
      ...
      <section class="flex flex-col justify-center items-center w-screen min-h-screen my-10">
        <div class="w-4/5 flex flex-col justify-center">
          ...
          <img src="/esimper_persona.jpg" class="w-full h-full my-5" />
        </div>
      </section>
      <section class="flex flex-col justify-center items-center w-screen min-h-screen my-10">
        <div class="w-4/5 flex flex-col justify-center">
          ...
          <img src="/esimper_user_journey.jpg" class="w-full h-full my-5" />
        </div>
      </section>
      <section class="flex flex-col justify-center items-center w-screen min-h-screen my-10">
        ...
        <div class="w-4/5 flex flex-row justify-around items-start">
          <div class="w-1/3 m-5 flex flex-col justify-center ">
            <img src="/esimper0.png" class="w-auto h-auto p-5" />
          ...
          <div class="w-1/3 m-5 flex flex-col justify-center ">
            <img src="/esimper1.png" class="w-auto h-auto p-5" />
            <h6 class="text-lg text-center text-slate-700 font-semibold mt-5">
      ...
      <section class="flex flex-col justify-center items-center w-screen min-h-screen my-10">
        ...
        <div class="w-4/5 flex flex-row flex-wrap justify-around mt-10 items-center">
          <div class="w-1/3 m-5">
            <img src="/esimper2.png" class="w-auto h-auto" />
          </div>
          <div class="w-1/3 m-5">
          ...
          <div class="w-1/3 m-5">
            <img src="/esimper3.png" class="w-auto h-auto" />
          </div>
        </div>
      </section>
      <section class="flex flex-col justify-center items-center w-screen min-h-screen my-10">
